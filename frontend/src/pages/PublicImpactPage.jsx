    ...
    <div className="min-h-screen bg-white font-sans selection:bg-tf-pink selection:text-white">
      ...
      <section className="relative pt-40 pb-20 bg-tf-purple overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center space-y-6">
           <span className="text-tf-pink font-black text-[11px] uppercase tracking-[0.4em] italic">Telemetry Matrix</span>
           <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter italic underline-offset-8 decoration-tf-pink/40">Our Global Impact</h1>
      ...
      <section className="py-24 bg-white max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-12 text-center items-center">
         {[
           ...
           { label: 'Families Secured', value: '450,000+', color: 'text-tf-pink' },
         ...
         <div className="max-w-7xl mx-auto px-6 overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
               {[
                 ...
                 <div key={idx} className="bg-white rounded-[3rem] p-16 space-y-12 relative overflow-hidden group hover:bg-tf-pink/5 transition-all duration-700 border border-white hover:border-tf-pink/20">
                    ...
                    <div className="pt-8 border-t border-slate-50 flex items-center justify-between">
                       <span className="text-tf-pink font-black text-[12px] uppercase tracking-widest">Target Met</span>
      ...
      <section className="py-20 text-center space-y-10">
         ...
         <button onClick={() => navigate('/login?tab=signup')} className="px-14 py-6 bg-tf-purple text-white rounded-full font-black uppercase text-[12px] tracking-[0.2em] shadow-xl shadow-tf-purple/20 hover:bg-tf-pink transition-all">Submit NGO Prospectus</button>
      </section>
    </div>
  );
}
