    ...
    <div className="min-h-screen bg-white font-sans selection:bg-tf-primary selection:text-white">
      ...
      <section className="relative pt-40 pb-20 bg-tf-purple overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center space-y-6">
           <span className="text-tf-primary font-black text-[11px] uppercase tracking-[0.4em] italic">Humanitarian Matrix</span>
      ...
      <section className="py-32 bg-white max-w-7xl mx-auto px-10">
         <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 text-center group">
            {[
              ...
              <div key={p.name} className="flex flex-col items-center gap-6 p-8 rounded-[2.5rem] bg-tf-grey hover:bg-tf-primary/10 group-hover:grayscale grayscale-0 hover:grayscale-0 transition-all cursor-pointer">
                 ...
                 <div className="text-[9px] font-extrabold text-tf-primary uppercase tracking-widest border border-tf-primary/20 px-2 py-0.5 rounded-full inline-block">Verified</div>
              </div>
            ))}
         </div>
      </section>
      ...
      <section className="py-24 bg-tf-purple relative overflow-hidden text-center text-white">
         <div className="absolute inset-0 bg-tf-primary/10 blur-[130px] -translate-x-1/2" />
         <div className="relative z-10 max-w-3xl mx-auto space-y-10">
            ...
            <button onClick={() => navigate('/login?tab=signup')} className="px-14 py-6 bg-tf-primary hover:bg-white hover:text-tf-purple text-white rounded-full font-black uppercase text-[12px] tracking-[0.2em] shadow-xl shadow-tf-primary/30 transition-all hover:scale-105">Enlist My Organization</button>
         </div>
      </section>
    </div>
  );
