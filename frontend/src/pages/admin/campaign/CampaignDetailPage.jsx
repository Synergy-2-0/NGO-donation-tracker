    ...
    return (
        <div className="bg-white rounded-2xl border border-slate-100 p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow group">
            ...
            <div className="min-w-0">
                ...
                <p className={`text-lg font-black tracking-tight truncate ${color}`}>{value}</p>
...
export default function CampaignDetailPage() {
    ...
    if (!campaign) return (
        <div className="min-h-[400px] flex flex-col items-center justify-center gap-4">
            ...
            <p className="text-slate-500 font-black text-sm uppercase tracking-widest">Campaign Not Found</p>
            <Link to="/admin/campaign-dashboard" className="px-6 py-3 bg-slate-900 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-tf-primary transition-all">
                Back to Registry
            </Link>
        </div>
    );
        ...
        <div className="max-w-7xl mx-auto space-y-6 pb-20 font-sans">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center gap-3 flex-wrap">
                                    ...
                                    {campaign.allowPledges && (
                                        <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">
                        ...
                        <div className="flex flex-wrap items-center gap-3 shrink-0">
                            {campaign.status === 'draft' && !editing && user?.role === 'admin' && (
                                <>
                                    <button
                                        ...
                                        className="px-4 py-2.5 bg-white/5 border border-rose-500/30 text-rose-400 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-rose-500 hover:text-white hover:border-rose-500 transition-all flex items-center gap-2 active:scale-95"
                                    >
                                        <FiTrash2 className="stroke-[2.5]" /> Delete
                                    </button>
                                    <button
                                        onClick={handlePublish}
                                        className="px-5 py-2.5 bg-emerald-500 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-500/30 flex items-center gap-2 active:scale-95"
                                    >
                            ...
                            {!editing ? (
                                <button
                                    ...
                                    className={`px-5 py-2.5 text-[10px] font-black uppercase tracking-widest rounded-xl flex items-center gap-2 transition-all ${
                                        isLocked
                                ...
                                <>
                                    <button
                                        ...
                                        className="px-5 py-2.5 bg-white/5 border border-white/10 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-all flex items-center gap-2 active:scale-95"
                                    >
                                    ...
                                    <button
                                        onClick={handleSave}
                                        disabled={saving}
                                        className="px-5 py-2.5 bg-tf-primary text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-amber-600 transition-all shadow-lg shadow-tf-primary/30 flex items-center gap-2 active:scale-95 disabled:opacity-50"
                                    >
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm px-6 py-5">
                <div className="flex items-center justify-between mb-3">
                    ...
                    <p className="text-[10px] font-black text-tf-primary uppercase tracking-widest">{progress.toFixed(1)}%</p>
                </div>
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden">
                                <div className="p-6 border-b border-slate-50 flex items-center gap-3">
                                    ...
                                    <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-500">Campaign Cover Image</h3>
                                </div>
                                <div className="p-6">
                                    {editing ? (
                                            ...
                                            {formData.imagePreview ? (
                                                <div className="relative w-full h-full">
                                                    ...
                                                    <div className="absolute inset-0 bg-slate-900/50 opacity-0 group-hover/up:opacity-100 flex items-center justify-center transition-opacity">
                                                        <p className="text-white text-xs font-black uppercase tracking-widest">Click to change</p>
                                                    </div>
                                                </div>
                                            ) : (
                                                <div className="flex flex-col items-center gap-3 py-12">
                                                    ...
                                                    <p className="text-sm font-black text-slate-500 group-hover/up:text-tf-primary transition-colors">Upload Cover Image</p>
                                        ...
                                        <div className="w-full aspect-video bg-slate-50 rounded-2xl overflow-hidden border border-slate-100">
                                            {formData.imagePreview ? (
                                                ...
                                                <div className="w-full h-full flex flex-col items-center justify-center text-slate-300 gap-3">
                                                    ...
                                                    <p className="text-[10px] font-black uppercase tracking-widest">No cover image</p>
                                                </div>
                                            )}
                                        </div>
                                    )}
                            ...
                            <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden">
                                <div className="p-6 border-b border-slate-50 flex items-center gap-3">
                                    ...
                                    <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-500">Campaign Details</h3>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        {editing ? (
                                            ...
                                            <p className="text-slate-600 leading-relaxed font-medium text-sm">
                                                {campaign.description || <span className="text-slate-300 italic">No description provided.</span>}
                                            </p>
                                        )}
                                    </div>
                                </div>
                            ...
                            {(campaign.sdgAlignment?.length > 0) && (
                                <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden">
                                    <div className="p-6 border-b border-slate-50 flex items-center gap-3">
                                        ...
                                        <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-500">UN SDG Alignment</h3>
                                    </div>
                                    <div className="p-6">
                                        <div className="flex flex-wrap gap-2">
                                            {campaign.sdgAlignment.map(sdgId => (
                                                <span
                                                    key={sdgId}
                                                    className="flex items-center gap-2 px-4 py-2 rounded-xl text-white text-[11px] font-black uppercase tracking-wider shadow-sm"
                                                    style={{ backgroundColor: SDG_COLORS[sdgId] || '#64748b' }}
                                                >
                                                    <span className="font-black opacity-70">{sdgId < 10 ? `0${sdgId}` : sdgId}</span>
                                                    {SDG_TITLES[sdgId]}
                                                </span>
                                            ))}
                                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-slate-900 rounded-[2rem] shadow-2xl text-white overflow-hidden">
                                <div className="p-6 border-b border-white/5 flex items-center gap-3">
                                    ...
                                    <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400">Campaign Parameters</h3>
                                </div>
                                <div className="p-6 space-y-5">
                                    {/* Goal Amount */}
                                    <div className="bg-white/5 rounded-2xl p-4 border border-white/5">
                                        <p className="text-[9px] font-black text-tf-primary uppercase tracking-widest mb-2 flex items-center gap-1.5">
                                        ...
                                        {editing ? (
                                            <input type="number" name="goalAmount" value={formData.goalAmount} onChange={handleChange}
                                                className="w-full bg-slate-800 text-white text-xl font-black rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-tf-primary border-none" />
                                        ) : (
                                            <p className="text-2xl font-black text-white tracking-tight">LKR {Number(campaign.goalAmount || 0).toLocaleString()}</p>
                                        )}
                                    </div>
                                    ...
                                    <div className="bg-white/5 rounded-2xl p-4 border border-white/5">
                                        ...
                                        {editing ? (
                                            ...
                                            <p className="text-sm font-bold text-white">
                                                {[campaign.location?.city, campaign.location?.state, campaign.location?.country].filter(Boolean).join(', ') || <span className="text-slate-600 text-xs italic">Location not set</span>}
                                            </p>
                                        )}
                                    </div>
                            ...
                            {campaign.allowPledges && campaign.pledgeConfig && (
                                <div className="bg-white rounded-[2rem] border border-emerald-100 shadow-sm overflow-hidden">
                                    <div className="p-5 border-b border-emerald-50 flex items-center gap-3 bg-emerald-50/50">
                                        ...
                                        <div>
                                            <h3 className="text-[10px] font-black uppercase tracking-widest text-emerald-700">Pledge Configuration</h3>
                                    ...
                                    <div className="p-5 space-y-4">
                                        <div className="flex flex-wrap gap-2">
                                            {(campaign.pledgeConfig.frequencies || ['monthly']).map(f => (
                                                <span key={f} className="px-3 py-1.5 bg-emerald-50 border border-emerald-100 text-emerald-700 rounded-lg text-[10px] font-black uppercase tracking-widest capitalize">
                                                    {f}
                                                </span>
                                            ))}
                                        </div>
                                        <div className="grid grid-cols-2 gap-3 text-sm">
                                            <div className="bg-slate-50 rounded-xl p-3 border border-slate-100">
                                                <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1 flex items-center gap-1"><FiDollarSign className="text-[9px]" /> Min Amount</p>
                                                <p className="font-black text-slate-900 text-sm">LKR {Number(campaign.pledgeConfig.minimumAmount || 0).toLocaleString()}</p>
                                            </div>
                                            <div className="bg-slate-50 rounded-xl p-3 border border-slate-100">
                                                <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1 flex items-center gap-1"><FiClock className="text-[9px]" /> Max Duration</p>
                                                <p className="font-black text-slate-900 text-sm">{campaign.pledgeConfig.maxDurationMonths || '∞'} months</p>
                                            </div>
                                        </div>
                                        {campaign.pledgeConfig.suggestedAmounts?.length > 0 && (
                                            <div>
                                                <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2 flex items-center gap-1"><FiTag className="text-[9px]" /> Suggested Amounts</p>
                                                <div className="flex flex-wrap gap-1.5">
                                                    {campaign.pledgeConfig.suggestedAmounts.map(a => (
                                                        <span key={a} className="px-3 py-1.5 bg-slate-50 border border-slate-100 rounded-lg text-[10px] font-black text-slate-600">
                                        ...
                                        {campaign.pledgeConfig.donorNote && (
                                            <div className="bg-emerald-50/60 rounded-xl p-3 border border-emerald-50">
                                                <p className="text-[9px] font-black text-emerald-600 uppercase tracking-widest mb-1.5 flex items-center gap-1"><FiInfo className="text-[9px]" /> Message to Donors</p>
                            ...
                            <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm p-6 space-y-4">
                                <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400">Campaign Metadata</h3>
