    ...
    <div className="min-h-screen bg-white font-sans selection:bg-tf-pink selection:text-white">
      ...
      <section className="relative pt-40 pb-20 bg-tf-purple overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center space-y-6">
           <span className="text-tf-pink font-black text-[11px] uppercase tracking-[0.4em] italic">System Protocol</span>
            ...
            <div className="space-y-12">
               {[
                 ...
                 <div key={item.step} className="flex gap-8 group">
                    <div className="w-16 h-16 bg-tf-grey group-hover:bg-tf-pink transition-all rounded-[1.5rem] flex items-center justify-center text-tf-purple group-hover:text-white font-black text-xl italic shrink-0">
                       {item.step}
                    </div>
            ...
            <div className="relative">
               <div className="bg-tf-grey rounded-[4rem] aspect-square flex items-center justify-center p-20 overflow-hidden shadow-inner">
                  <div className="w-full h-full bg-white rounded-[3rem] shadow-2xl p-10 flex flex-col justify-between relative group">
                     <div className="absolute top-10 right-10 w-20 h-20 bg-tf-pink/10 rounded-full blur-2xl" />
               ...
               <div className="absolute -top-10 -right-10 w-48 h-48 bg-tf-pink rounded-[3rem] rotate-12 flex items-center justify-center text-white shadow-2xl shadow-tf-pink/30 animate-pulse">
      ...
      <section className="py-20 bg-tf-grey text-center">
         <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="flex justify-center gap-6">
               <button onClick={() => navigate('/login?tab=signup')} className="px-10 py-4 bg-tf-pink text-white rounded-full font-black uppercase text-[12px] tracking-widest shadow-lg shadow-tf-pink/20 transition-all active:scale-95">Start Donating</button>
